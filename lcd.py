...
try:
    ...
    srt = "     Ulsan-Singyeongju-Dongdaegu-GimcheonGumi-Daejeon-Gwangmyeong-Seoul-Haengshin     "
    ...
    while True:
        for i in range(-15, len(str) + 15):
            ...
            time.sleep(0.01)
            display.lcd_display_extended_string(' ' * max(-i, 0) + str[max(i, 0):min(i+15, len(str))] + ' ', 2)
            time.sleep(0.07)
